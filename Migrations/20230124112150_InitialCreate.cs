    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimeslipId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timeslips_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Timeslips_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Credivalores CV Desarrollo" });

            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "TaskId", "DepartmentId", "Name" },
                values: new object[] { 1, 1, "Daily six" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timeslips_ApplicationUserId",
                table: "Timeslips",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Timeslips_TaskId",
                table: "Timeslips",
                column: "TaskId");
        }
